...
void setup() {
	...
	if (var_aux_verificacao_criacao_objetos == true) {
		...
		//xTaskCreatePinnedToCore(vTask_Web_Server, "Web_Server", 4096,(void*) pcTextFor_Web_Server, 1, NULL, 1);

		//xTaskCreatePinnedToCore(vTask_Kepp_Wifi_Live, "Kepp_Wifi_Live", 4096,(void*) pcTextFor_Kepp_Wifi_Live, 1, NULL, 1);
